...
export const allApps = [
    ...
    { name: 'Discounts', route: 'resources/sample-discounts', icon: Percent },
    ...
    { name: 'Design Days', route: 'resources/design-days', icon: Calendar },
    { name: 'Search Fabrics', route: 'fabrics/search-form', icon: Search },
    { name: 'Request COM Yardage', route: 'fabrics/com-request', icon: Paperclip },
    ...
    { name: 'New Dealer Sign-Up', route: 'resources/dealer-registration', icon: UserPlus },
];
...
export const QUICK_ACCESS_APPS = [
    ...
    { id: 'discounts', name: 'Discounts', route: 'resources/sample-discounts', icon: Percent, isDefault: false },
    { id: 'loaner-pool', name: 'Loaner Pool', route: 'resources/loaner-pool', icon: Package, isDefault: false },
    { id: 'discontinued-finishes', name: 'Discontinued Finishes', route: 'resources/discontinued-finishes', icon: Palette, isDefault: false },
    { id: 'social-media', name: 'Social Media', route: 'resources/social-media', icon: Share2, isDefault: false },
    { id: 'design-days', name: 'Design Days', route: 'resources/design-days', icon: Calendar, isDefault: false },
    { id: 'presentations', name: 'Presentations', route: 'resources/presentations', icon: MonitorPlay, isDefault: false },
    { id: 'install-instructions', name: 'Install Instructions', route: 'resources/install-instructions', icon: Wrench, isDefault: false },
