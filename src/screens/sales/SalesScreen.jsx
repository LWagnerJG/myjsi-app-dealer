      ...
      {data.map((m, idx) => {
        ...
        return (
          <button
            ...
            className="w-full grid grid-cols-[2.5rem,1fr,auto] items-center gap-3 py-0.5 rounded-lg transition-all hover:bg-black/[0.02] active:scale-[0.99]"
          >
            <span 
...
const CustomerMonthlyBreakdown = ({ monthData, orders, theme, onBack }) => {
  ...
  return (
    <div>
      <button 
        onClick={onBack} 
        className="flex items-center gap-1 text-[13px] font-semibold mb-3 transition-all hover:opacity-70" 
    ...
    >
      ...
      <div className="grid grid-cols-2 gap-2.5">
        <GlassCard
          ...
          className="flex items-center gap-2.5 p-3.5 active:scale-[0.98] transition-transform"
        >
          <Trophy className="w-4.5 h-4.5 flex-shrink-0" style={{ color: theme.colors.accent }} />
        ...
        <GlassCard
          ...
          className="flex items-center gap-2.5 p-3.5 active:scale-[0.98] transition-transform"
        >
          <Gift className="w-4.5 h-4.5 flex-shrink-0" style={{ color: theme.colors.accent }} />
          <span className="font-semibold text-[13px]" style={{ color: theme.colors.textPrimary }}>
            Rewards
          </span>
          <ChevronRight className="w-4 h-4 ml-auto flex-shrink-0" style={{ color: theme.colors.textSecondary }} />
